...
[1] = LAYOUT(
   ...
   KC_TAB, KC_PGUP, KC_HOME,   KC_UP,  KC_END, KC_NO,                          KC_PAST,   KC_P4,   KC_P5,   KC_P6, KC_LPRN, KC_RBRC,
  KC_LGUI, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,                          KC_PMNS,   KC_P1,   KC_P2,   KC_P3, KC_RPRN, KC_RGUI,
  KC_LSFT, QK_LOCK, KC_BTN1, KC_BTN3, KC_BTN2, KC_KB_POWER, KC_TRNS,  KC_TRNS, KC_PPLS,   KC_P0, KC_PDOT, KC_PCMM, KC_BSLS, KC_RSFT,
...
[2] = LAYOUT(
  ...
  KC_LSFT,   KC_NO, KC_WH_L, KC_BTN3, KC_WH_R,   KC_NO, KC_TRNS,  KC_TRNS,   KC_NO, KC_BTN1, KC_BTN3, KC_BTN2, KC_BSLS, KC_RSFT,
                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
/* ADJUST
 * ,----------------------------------------.                    ,-----------------------------------------.
