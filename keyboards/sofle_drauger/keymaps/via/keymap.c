...
[1] = LAYOUT(
  ...
  KC_LSFT, KC_CAPS, KC_BTN1, KC_BTN3, KC_BTN2,  KC_PWR, KC_TRNS,     C(a), KC_PPLS,   KC_P0, KC_PDOT, KC_PCMM, KC_BSLS, KC_RSFT,
...
[2] = LAYOUT(
  ...
  KC_LSFT,   KC_NO, KC_WH_L, KC_BTN3, KC_WH_R,   KC_NO, KC_TRNS,     S(a),   KC_NO, KC_BTN2, KC_BTN3, KC_BTN1, KC_BSLS, KC_RSFT,
